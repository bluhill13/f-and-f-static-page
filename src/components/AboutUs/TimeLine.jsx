...
import omOssBilde from "../../images/images/om-oss-bilde.jpg";
const Timeline = () => {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="relative">
            ...
            <div className="mb-8 flex flex-col items-center">
              <div className="bg-blue-600 text-black px-4 py-2 rounded-md mb-2">
                JAN, 2006
              </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="bg-gray-100 text-center p-4 rounded-md">
                ...
                <p>
                  Vi fikk vår første egenproduserte Verdensmester. Thea
                  Vatshölle tok VM-gull i kickboxing (fullkontakt)
                </p>
              </div>
            </div>
          </div>
